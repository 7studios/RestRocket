...
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation ARCReflectiveFillStyle

@synthesize color = _color,
            withBottomHighlight = _withBottomHighlight;
...
+ (ARCReflectiveFillStyle*)styleWithColor:(UIColor*)color next:(ARCStyle*)next {
    
  ARCReflectiveFillStyle* style = [[self alloc] initWithNext:next];
  style.color = color;
...
+ (ARCReflectiveFillStyle*)styleWithColor:(UIColor*)color withBottomHighlight:(BOOL)withBottomHighlight next:(ARCStyle*)next {
...
- (void)draw:(ARCStyleContext*)context {
    ...
    NSArray* colors = [[NSArray alloc] initWithObjects:topStartHighlight, topEndHighlight, clearColor, clearColor, botEndHighlight, nil];
