...
// Style (private)
#import "ARCShapeInternal.h"


///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation ARCRoundedRectangleShape
...
+ (ARCRoundedRectangleShape*)shapeWithRadius:(CGFloat)radius {
    ARCRoundedRectangleShape* shape = [[ARCRoundedRectangleShape alloc] init];
    shape.topLeftRadius = shape.topRightRadius = shape.bottomRightRadius = shape.bottomLeftRadius = radius;
    return shape;
}


+ (ARCRoundedRectangleShape*)shapeWithTopLeft:(CGFloat)topLeft topRight:(CGFloat)topRight bottomRight:(CGFloat)bottomRight bottomLeft:(CGFloat)bottomLeft {
    ARCRoundedRectangleShape* shape = [[ARCRoundedRectangleShape alloc] init];
